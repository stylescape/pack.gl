...
/**
 * BaseStepAction provides a common foundation for step actions in the pack.gl pipeline.
 * This class implements the StepActionInterface and provides basic structure and utility methods
 * that can be extended by specific actions like BuildAction, LintAction, etc.
 */
export abstract class BaseStepAction implements StepActionInterface {
