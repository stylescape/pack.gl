...
var TypeScriptCompiler = (function () {
    function TypeScriptCompiler(configFilePath, customConfig) {
        if (customConfig === void 0) { customConfig = {}; }
        this.config = this.loadConfig(configFilePath, customConfig);
    }
...
//# sourceMappingURL=TypeScriptCompiler%20copy.js.map