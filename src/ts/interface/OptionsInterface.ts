...
export interface OptionsInterface {
     ...
     * - 0 or undefined: No limit, all stages run in parallel as allowed by
     *      their dependencies.
    ...
    /**
     * Enables dry-run mode for the pipeline.
     * - `true`: Simulates the pipeline execution without performing actual
     *      actions.
     * - `false`: Executes the pipeline as configured.
     * Useful for testing configurations and understanding the pipeline flow.
     * Default: `false`.
     */
    dryRun?: boolean;

    /**
     * Specifies the default priority level for stages and steps.
     * Priority can influence the execution order of tasks, especially in
     * parallel execution.
    ...
    /**
     * Specifies whether to enable detailed timing information for pipeline
     * execution.
     * - `true`: Logs the time taken for each stage and step.
     * - `false`: Suppresses timing logs.
     * Default: `false`.
     */
