...
export class PipelineManager {
    ...
    public restartPipeline(): void {
        ...
        this.pipelineProcess.on('close', (code) => {
            ...
            this.reloadServer.reloadClients(); // Reload clients when pipeline restarts
        });
    ...
    /**
     * Restarts the pipeline with a delay, useful for throttling restarts when changes occur rapidly.
